...
Versão atual: **0.10.0** — ver [Releases](../../releases) e o [CHANGELOG](CHANGELOG.md).
...
- **Histórico também para os discos** — os tamanhos das pastas já são registados e desenhados num gráfico, mas o espaço livre em disco continua a ser medido de cinco em cinco segundos e deitado fora. O mesmo tratamento responderia a «quando é que este disco começou a encher?»; a questão em aberto é o que identifica um volume entre montagens e formatações, porque o caminho de montagem não serve.

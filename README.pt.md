...
- **Fechar a dica de sobreposição ao arrastar o painel** — arrastar o painel para outro sítio deixa a dica que estava aberta nesse momento (CPU, memória ou um disco) pendurada no sítio antigo, em vez de desaparecer com a mudança.

...
Current version: **0.10.0** — see [Releases](../../releases) and the [CHANGELOG](CHANGELOG.md).
...
- **History for disks too** — folder sizes are recorded and charted now, but free disk space is still measured every five seconds and thrown away. The same treatment would answer "when did this drive start filling up?"; the open question is what identifies a volume across remounts and reformats, since a mount path is not it.
